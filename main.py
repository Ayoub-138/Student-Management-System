...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        add_student_action = QAction(QIcon("icons/add.png"),"Addd Student", self)
...
class AboutDialog(QMessageBox):
    def __init__(self):
        ...
        content = """
        This app was created duting the course "The python Mega Course".
...
class DeleteDialog(QDialog):
    def __init__(self):
        ...
        layout = QGridLayout()
        confirmation = QLabel("Are you sure you want to delete entry?")
        yes = QPushButton("Yes")
        no = QPushButton("No")
    ...
    def delete_student(self):
        ...
        confirmation_widget.setText("The entry was deleted successfully!")
